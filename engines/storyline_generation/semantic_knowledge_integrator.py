...
# .parent.parent / "knowledge_base"))  # Removed during reorganization

try:
    # Try direct import from core.lighthouse package
    # .parent.parent))  # Removed during reorganization
    from core.lighthouse.traditions.unified_knowledge_retriever import UnifiedKnowledgeRetriever
    from core.lighthouse.retrievers.focused_mystical_retriever import FocusedMysticalRetriever
